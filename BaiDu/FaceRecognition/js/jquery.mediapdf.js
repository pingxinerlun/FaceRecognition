    ...
    */
    ...
    function generate(el, opts, player) {
        ...
        if (player == 'iframe') {
            ...
            a = ['<object width="' + opts.width + '"  wmode="opaque" height="' + opts.height + '" '];
            ...
            a = ['<object type="' + o.mimetype + '" width="' + opts.width + '" height="' + opts.height + ' wmode=opaque"'];
            ...
            a = ['<embed width="' + opts.width + '" height="' + opts.height + '"  wmode="opaque" style="display:block"'];
