...
(function ($, undefined) {
    var defaults = {
        ...
        titleFormat: {
            month: 'yyyy年 MMMM月',
            week: "yyyy年MMMM月dd{'&#8212;'dd日}",
            day: 'yyyy年MMMM月dd日 dddd'
        },
        columnFormat: {
            month: 'ddd',
            week: 'ddd M/d',
    ...
    function Calendar(element, options, eventSources) {
        ...
        function changeView(newViewName) {
            if (!currentView || newViewName != currentView.name) {
                ...
                $.cookie("calendar_view", newViewName, {
                    path: "/"
                });
            }
        }
    ...
    function Header(calendar, options) {
        ...
        function render() {
            ...
            if (sections) {
                element = $("<table class='fc-header' style='width:100%; margin-bottom:5px;'/>")
                    .append(
                        $("<tr/>")
                            .append(renderSection('left'))
                            .append(renderSection('center'))
                            .append(renderSection('right'))
                    ).append("<tr><td style='text-align:center;color:#43b017;'>0</td><td style='text-align:center;color:#0096ff;'>5</td><td style='text-align:center;color:#ff7e00;'>6</td></tr><tr><td style='text-align:center;'>出勤</td><td style='text-align:center;'>缺勤</td><td style='text-align:center;'>异常</td></tr>");
                return element;
            }
        }
